...
from models.architecture_sa import MainArchitecture as SAMainArchitecture
...
def main():
    ...
    if config.model == 'sa':
        network = SAMainArchitecture(vocab, config, word_table, tag_table, etype_table) 
